...
UpdateStmt::UpdateStmt(Table *table, Field field,Value *values,FilterStmt*filter_stmt )
...
RC UpdateStmt::create(Db *db, const UpdateSqlNode &update_sql, Stmt *&stmt)
{
  ...
  //attribute type not equal
  AttrType update_type =update_sql.value.attr_type();
  AttrType field_type  =field_meta->type();
  if(update_type!=field_type){
